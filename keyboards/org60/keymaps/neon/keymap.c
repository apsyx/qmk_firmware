...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /*
    ...
    |          |          |          |                                                        |          |      |        |        |        |
    |          |          |          |                                                        |          |      |        |        |        |
    | Ctrl     | Win      | Alt      | Space                                                  |          | Up   |  Down  | PgUp   | PgDn   |
    '--------------------------------------------------------------------------------------------------------------------------------------'
  */
   ...
   //          |          |          |                                                        |          |      |        |        |        |
   //          |          |          |                                                        |          |      |        |        |        |
     KC_LCTL,   F(0),      KC_LALT,   KC_SPC,                                                  KC_UP,    KC_DOWN,  KC_NO, KC_PGUP, KC_PGDN),
   //--------------------------------------------------------------------------------------------------------------------------------------'
  ...
  /*
    ...
    |            |        |        |        |        |        |        |        |        |        |        |        |        |             |
    |            |        |        |        | RGB    | RGB    | RGB    | RGB    |        |        |        |        |        |             |
    | Tab        | 7      | 8      | 9      | Toggle | Mode   | Pwr+   | Pwr-   |        | Insert | Pause  | Home   | End    | Reset       |
    |--------------------------------------------------------------------------------------------------------------------------------------|
    |               |        |        |        |        |        |        |        |        |        |        |        |                   |
    ...
    |                   |        |        |        |        |        |        |        |        |        |        |░░░░░░|        |░░░░░░░░|
    |                   |        |        |        |        | Back   | Back   |        | Prev   | Next   |        |░░░░░░|        |░░░░░░░░|
    | Shift             | 1      | 2      | 3      |        | Light+ | Light- |        | Track  | Track  |        |░░░░░░| Shift  |░░░░░░░░|
    |--------------------------------------------------------------------------------------------------------------------------------------|
    |          |          |          |                                                        |          |      |        |        |        |
    |          |          |          |                                                        |          |      |        |        |        |
  ...
  */
   ...
   //            |        |        |        |        |        |        |        |        |        |        |        |        |             |
   //            |        |        |        |        |        |        |        |        |        |        |        |        |             |
     KC_TAB,       KC_7,    KC_8,    KC_9,    RGB_TOG, RGB_MOD, RGB_VAI, RGB_VAD, KC_NO,   KC_INS,  KC_PAUS, KC_HOME, KC_END,  RESET,      
   //--------------------------------------------------------------------------------------------------------------------------------------|
   //               |        |        |        |        |        |        |        |        |        |        |        |                   |
   //               |        |        |        |        |        |        |        |        |        |        |        |                   |
   ...
   //                   |        |        |        |        |        |        |        |        |        |        |░░░░░░|        |░░░░░░░░|
   //                   |        |        |        |        |        |        |        |        |        |        |░░░░░░|        |░░░░░░░░|
     KC_LSFT, KC_NO,     KC_1,    KC_2,    KC_3,    KC_NO,   BL_INC,  BL_DEC,  KC_NO,   KC_MPRV, KC_MNXT, KC_NO,   KC_NO, KC_RSFT, KC_NO,   
   //--------------------------------------------------------------------------------------------------------------------------------------|
   //          |          |          |                                                        |          |      |        |        |        |
   //          |          |          |                                                        |          |      |        |        |        |
     KC_LCTL,   F(0),      KC_LALT,   KC_0,                                                    KC_RGUI,     KC_MUTE, KC_NO, KC_VOLD, KC_VOLU),
   //--------------------------------------------------------------------------------------------------------------------------------------'
