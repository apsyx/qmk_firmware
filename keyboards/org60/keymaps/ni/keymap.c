...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /*
    ...
    |          |          |          |                                                        |          |      |        |        |        |
    |          |          |          |                                                        |          |      |        |        |        |
    | Ctrl     | Win      | Alt      | Space                                                  | Alt      |KC_MENU|       | Fn     | Ctrl   |
    '--------------------------------------------------------------------------------------------------------------------------------------'
  */
   ...
   //          |          |          |                                                        |          |      |        |        |        |
   //          |          |          |                                                        |          |      |        |        |        |
     KC_LCTL,   KC_LGUI,      KC_LALT,   KC_SPC,                                               KC_RALT,    KC_MENU,  KC_NO, F(0),    KC_RCTL),
   //--------------------------------------------------------------------------------------------------------------------------------------'
  ...
  /*
    ...
    |          |          |          |                                                        |          |      |        |        |        |
    |          |          |          |                                                        |          |      |        |        |        |
    | Ctrl     | Win      | Alt      | 0                                                      | Alt      |Menu  |        | Fn     | Ctrl   |
    '--------------------------------------------------------------------------------------------------------------------------------------'
  */
   ...
   //          |          |          |                                                        |          |      |        |        |        |
   //          |          |          |                                                        |          |      |        |        |        |
     KC_LCTL,   KC_LGUI,   KC_LALT,   KC_0,                                                    KC_RALT,     KC_MENU, KC_NO, F(0),  KC_RCTL),
   //--------------------------------------------------------------------------------------------------------------------------------------'
